...
class VxrAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Size get preferredSize =>
      Size.fromHeight(140 + (subtitle != null ? 18 : 0) + (bottom != null ? bottomHeight : 0));
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(Icons.tune, size: 16, color: t.accent),
            ),
          ),
        ],
      ),
...
/// Bell icon with a red unread badge. Use in `VxrAppBar.actions`.
/// Provide [unreadCount] (0 hides the badge) and [onTap] to open the panel.
class VxrNotificationBell extends StatelessWidget {
  final int unreadCount;
  final VoidCallback onTap;
  final bool onGradient;
  final double size;

  const VxrNotificationBell({
    super.key,
  ...
  @override
  Widget build(BuildContext context) {
    final iconColor = onGradient ? Colors.white : VxrTokens.text;
    final badgeFg = Colors.white;
    final badgeBg = onGradient ? VxrTokens.danger : VxrTokens.danger;
                ...
                Positioned(
                  ...
                  child: Container(
                    padding: EdgeInsets.symmetric(
                        horizontal: unreadCount > 9 ? 5 : 4, vertical: 1),
                    constraints:
